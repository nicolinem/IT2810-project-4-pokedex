...
export default function LoginPage( props : Props) {
  ...
  return (
    <div id="authentication-modal"  aria-hidden="true" className="text-gray-900 overflow-y-auto overflow-x-hidden fixed top-0 right-0 z-50 w-full md:inset-0 h-modal md:h-full">
    <div className="absolute p-4 w-full right-0 max-w-md h-full md:h-auto">
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="mt-5">
              Not registered? <a onClick={props.onSignUp}className="text-blue-700 hover:underline dark:text-blue-500 hover:cursor-pointer">Create account</a>
            </div>
